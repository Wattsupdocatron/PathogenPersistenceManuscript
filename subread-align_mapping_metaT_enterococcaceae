...
#map reads metatranscriptomics reads to Enterococcaceae isolate genomes
#repeat for each metatranscriptomics sample DC1-DC3

# List of genomes
genomes=("E6" "E10" "E15" "E17")
...
for genome in "${genomes[@]}"; do
    ...
    # Build subread index
    subread-buildindex -o "${genome}-index" "${genome}_assembly.fasta" EF-DC1-contigs.fasta
